...
@router.post(
    ...
    responses={
        ...
        400: {
            ...
            "content": {
                "application/json": {"example": {"detail": "Institute already exists"}}
            },
        },
        500: {
            ...
            "content": {
                "application/json": {
                    "example": {"detail": "Error registering institute: ERROR"}
                }
            },
        },
    },
...
@router.post(
    ...
    responses={
        200: {
            ...
            "content": {
                "application/json": {
                    "example": {"message": "Login successful", "institute_id": "uuid"}
                }
            },
        },
        401: {
...
def login_institute(session: SessionDep, loginrequest: LoginRequest = Form(...)):
    try:
        ...
        return {
            ...
            "user_id": credentials.institute_id,
...
def update_institute(
    session: SessionDep, request: InstitutionUpdateRequest = Form(...)
):
    try:
    ...
    responses={
        ...
        404: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "detail": "No institutions found matching the given name"
                    }
                }
            },
        },
        500: {
            ...
            "content": {
                "application/json": {
                    "example": {"detail": "Error fetching institutions: some error"}
                }
            },
        },
    },
)
def search_institutes(session: SessionDep, name: str):
    try:
...
@router.post(
    ...
    responses={
        ...
        404: {
            ...
            "content": {
                "application/json": {"example": {"detail": "Endorsement not found"}}
            },
        },
        500: {
            "description": "Server error",
            "content": {
                "application/json": {
                    "example": {"detail": "Error updating endorsement: some error"}
                }
            },
        },
    },
    ...
    try:
        endorsement = session.exec(
            select(endorsements).where(
                endorsements.endorsement_id == request.endorsement_id
            )
        ).first()
